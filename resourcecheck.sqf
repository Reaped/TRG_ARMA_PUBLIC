...
while {true} do {
	...
	*/
	...
	/*
	Author: Sparker.
	Roadblock placement based on WarStatistics
	Loop through the ws_grid and spawn roadblocks where enemy activity is higher than threshold if the nearest city to the roadblock belongs to enemy
	Don't spawn more than 1 roadblock per grid element
	*/
